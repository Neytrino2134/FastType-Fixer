...
import { Keyboard, KeyRound, Mic, Brain, Leaf, ShieldAlert } from 'lucide-react';
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="bg-slate-900 border-b border-slate-800 shadow-xl z-40 w-full shrink-0 animate-in slide-in-from-top-2 duration-200 h-full md:h-auto overflow-y-auto">
        ...
        {/* FOOTER */}
        <div className="fixed bottom-0 left-0 w-full md:static border-t border-slate-800 p-4 flex items-center justify-between bg-slate-900 safe-area-bottom">
             {/* Left: Change API Key */}
             <button 
                onClick={onResetKey}
